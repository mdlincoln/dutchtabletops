...
library(fpc)
n_clust <- 10
boot_clust <- clusterboot(asymm_motif_dist, clustermethod = hclustCBI, method = "ward.D2", k = n_clust)
summary(boot_clust$result)
cluster_stability <- data_frame(cluster = 1:10, stability = boot_clust$bootmean)
```

```{r motif_clusterboot_plot}
pca_df %>% 
